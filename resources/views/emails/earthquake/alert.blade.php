                ...
                <table class="main" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="alert alert-warning">
                            Warning: {{ count($data['earthquakes']->features) }} earthquake(s) detected.
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <a href="{{ config('app.url') }}/earthquakes/{{ $earthquake->id }}" target="_blank">{{ $earthquake->properties->title }}</a> <br/>
